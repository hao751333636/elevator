...
//    private static final int TYPE_FLASH_AUTO = 0x021;
    ...
    private void initView() {
        ...
        image_out = (ImageView) view.findViewById(R.id.image_out);
        ...
        image_add.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                CameraInterface.getInstance().zoomAdd();
            }
        });
        image_out.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                seekbar.setMax(CameraInterface.getInstance().getMaxZoom());
                seekbar.setProgress(CameraInterface.getInstance().getCurrentZoom());
            }
        }.start();
    }
...
//                break;
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        CameraInterface.getInstance().setZoom(progress);
    }
