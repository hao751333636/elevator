...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	protected boolean isReadyForPullEnd() {
		float exactContentHeight = new Double(Math.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale())).floatValue();
	...
	final class InternalWebViewSDK9 extends WebView {
		...
		private int getScrollRange() {
			return (int) Math.max(0, new Double(Math.floor(mRefreshableView.getContentHeight() * mRefreshableView.getScale())).floatValue()
