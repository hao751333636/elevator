...
import com.sinodom.elevator.adapter.elist.NoticeAdapter;
 ...
 * 通知通告
 */
public class NoticeActivity extends BaseActivity implements BaseAdapter.OnItemClickListener {
    ...
    private void init() {
        ...
        mAdapter = new NoticeAdapter(context);
    ...
    private void loadData() {
        ...
        Call<ResponBean> call = server.getService().getArticleList(map);
            ...
            public void onResponse(Call<ResponBean> call, Response<ResponBean> response) {
                ...
                try {
                    if (response.body().isSuccess()) {
                        ...
                        List<NoticeBean> list = gson.fromJson(response.body().getData(), new TypeToken<List<NoticeBean>>() {
                        }.getType());
