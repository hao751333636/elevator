...
public class HistoricalDetailsActivity extends BaseActivity {
    ...
    private void init() {
        ...
        mAdapter = new HistoryDetailAdapter(HistoricalDetailsActivity.this, mDataBeen);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (!lvRecord.isRefreshing()) {
                    if (!mDataBeen.get(position).getMaintenancePeriod().trim().equals("未维保")) {
                        ...
                        intent.setClass(HistoricalDetailsActivity.this, RecordDetailsActivity.class);
    ...
    private void loadData() {
        ...
        Call<ResponBean> call = server.getService().getNewCheckHistoryList(map);
