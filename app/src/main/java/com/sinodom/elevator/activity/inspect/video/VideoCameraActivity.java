...
public class VideoCameraActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (DeviceUtils.isZte()) {
            if (dcim.exists()) {
                jCameraView.setSaveVideoPath(dcim + "/Elevator/");
            } else {
                jCameraView.setSaveVideoPath(dcim.getPath().replace("/sdcard/", "/sdcard-ext/") + "/Elevator/");
            }
        } else {
            jCameraView.setSaveVideoPath(dcim + "/Elevator/");
        }
        ...
        jCameraView.setJCameraLisenter(new JCameraListener() {
            ...
            public void recordSuccess(String url, Bitmap firstFrame) {
                ...
                setResult(Constants.Code.RESCUE_OK, new Intent().putExtra("url", url));
                finish();
            }
        });
        //左边按钮点击事件
