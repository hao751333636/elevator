...
import com.sinodom.elevator.adapter.elist.PropertyInspectionAdapter;
...
public class PropertyInspectionActivity extends BaseActivity {
    ...
    private List<PropertyInspectionBean> list = new ArrayList<>();
    private PropertyInspectionAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_property_inspection);
...
//        getOnlineRatesPic();
        ...
        mAdapter = new PropertyInspectionAdapter(context, list, "巡查状态：", true);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (!lvInternetAlarm.isRefreshing()) {
                    ...
                    intent.setClass(context, PropertyInspectionDetailsActivity.class);
...
//        map.put("IsInstallation", stateId);   //是否安装
        Call<ResponBean> call = server.getService().propertyChecks(map);
            ...
            public void onResponse(Call<ResponBean> call, Response<ResponBean> response) {
                try {
                    if (response.body().isSuccess()) {
                        ...
                        pageNumber++;
                        List<PropertyInspectionBean> mDataBeen2 = new ArrayList<>();
                        mDataBeen2.addAll((List<PropertyInspectionBean>) gson.fromJson(response.body().getData(), new TypeToken<List<PropertyInspectionBean>>() {
                        }.getType()));
        ...
        switch (view.getId()) {
            ...
            case R.id.ivScanning:
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    if (!permission) {
                        ActivityCompat.requestPermissions(PropertyInspectionActivity.this,
                                new String[]{Manifest.permission.CAMERA}, 100);
                    } else {
                        Intent intent = new Intent(PropertyInspectionActivity.this, CaptureActivity.class);
                        intent.putExtra("source", CaptureActivity.SCAN_WUXC);
