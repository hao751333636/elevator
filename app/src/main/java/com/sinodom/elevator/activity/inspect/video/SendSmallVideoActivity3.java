package com.sinodom.elevator.activity.inspect.video;
 ...
 */
public class SendSmallVideoActivity3 extends AppCompatActivity implements View.OnClickListener {
...
//        et_send_content.setOnClickListener(this);
    ...
    private void initData() {
        ...
        Bitmap bitmap = ImageUtil.getBitmap(videoScreenshot);
        iv_video_screenshot.setImageBitmap(bitmap);
        Logger.d("url=" + videoUri);
    }
