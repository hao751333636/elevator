 ...
 * 救援维保人员信息列表
 */
public class RescueMaintenanceAdapter extends BaseAdapter<RescueDetailBean.LiftBean.MaintUsersBean> {

    public RescueMaintenanceAdapter(Context context) {
        super(context);
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final RescueDetailBean.LiftBean.MaintUsersBean bean = data.get(i);
