...
public class PropertyInspectionDetailsAdapter extends BaseAdapter<PropertyInspectionDetailsBean.PropertyCheckDetailsBean> {


    private String name;


    public PropertyInspectionDetailsAdapter(Context context, List<PropertyInspectionDetailsBean.PropertyCheckDetailsBean> mList, String name) {
        super(context, mList);
        this.name = name;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_property_inspection_details, null);
    ...
    private void instantiation(ViewHolder holder, PropertyInspectionDetailsBean.PropertyCheckDetailsBean checkDetailsBean) {
        holder.tvContent.setText("" + checkDetailsBean.getPropertyStep().getStepName().trim());
