...
import static com.sinodom.elevator.util.DateUtil.parse;
...
public class TimeSelector {
    ...
    private void initDialog() {
        if (seletorDialog == null) {
            ...
            seletorDialog.setContentView(R.layout.view_dialog_selector);
    ...
    private void initParameter() {
        ...
        selectedCalender.setTime(parse(DateUtil.format(new Date(System.currentTimeMillis()), FORMAT_STR), FORMAT_STR));
    }
    ...
    private void loadComponent() {
        ...
        nowCalendar.setTime(parse(DateUtil.format(new Date(System.currentTimeMillis()), FORMAT_STR), FORMAT_STR));
        ...
        year_pv.setSelected(year.indexOf(nowCalendar.get(Calendar.YEAR) + ""));
        month_pv.setSelected(month.indexOf(nowCalendar.get(Calendar.MONTH) < 9 ? "0" + (nowCalendar.get(Calendar.MONTH) + 1) : ((nowCalendar.get(Calendar.MONTH) + 1) + "")));
        day_pv.setSelected(day.indexOf(nowCalendar.get(Calendar.DAY_OF_MONTH) + ""));
        hour_pv.setSelected(hour.indexOf(nowCalendar.get(Calendar.HOUR_OF_DAY) + ""));
        minute_pv.setSelected(minute.indexOf(nowCalendar.get(Calendar.MINUTE) + ""));
        excuteScroll();
    }
